...
options = {'c1': 0.7, 'c2': 1.5, 'w':0.7, 'k': 20, 'p':2}
...
cost, pos = optimizer.optimize(f, print_step=1, iters=200, verbose=1)
...
selected_df.to_csv(cd.OUTPUT_DIR+"/gs_results_pso1_svm_accuracy.csv", sep='\t', encoding='utf-8')
